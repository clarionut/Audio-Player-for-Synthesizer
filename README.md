...
I'm not sure that this will be a particularly useful module, but I wanted to experiment using FETs as switches to allow external control. Also the modules are very cheap!
